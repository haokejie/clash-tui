...
The GitHub Actions `Release` workflow builds the package on tags or manual dispatch and uploads the online `install.sh`, archive, sidecar manifest, and `.sha256` file.
